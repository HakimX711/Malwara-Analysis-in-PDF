...
def extract_featues(output):
    ...
    # Extract the number of 'obj' keywords
    ...
    try:
        # Convert the extracted value to an integer and add it to the list of features
    ...
    # Extract the number of 'endobj' keywords
    ...
    try:
        ...
        # If the value cannot be converted to an integer, set it to a default value of 3
        stream = 3
        tuples.append(stream)
        pass

    # Extract the number of 'endstream' keywords
    ...
    # Extract the number of 'xref' keywords
    ...
    try:
        ...
        # If the value cannot be converted to an integer, set it to a default value of 1
        xref = 1
        tuples.append(xref)
        pass

    # Extract the number of 'trailer' keywords
    ...
    # Extract the number of 'startxref' keywords
